      ...
      <template v-slot:modal-title>
        ...
        <form ref="form">
          <div class="form-group">
            ...
            <input type="text" nama_siswa="nis" class="form-control" id="nis" placeholder="nis" v-model="nis">
          </div>
          <div class="form-group">
            <label for="nama_siswa" class="col-form-label">Nama Siswa</label>
            <input type="text" nama_siswa="nama_siswa" class="form-control" id="nama_siswa" placeholder="nama siswa" v-model="nama_siswa">
          </div>
          <div class="form-group">
            <label for="role" class="col-form-label">Kelas</label>
            <select class="form-control" name="kelas" id="kelas" v-model="kelas">
              <option value="XI RPL 1" checked>XI RPL 1</option>
              <option value="XI RPL 2">XI RPL 2</option>
            </select>
          </div>
          <!-- <div class="form-group">
            <label for="role" class="col-form-label">Role</label>
            <select class="form-control" nama_siswa="role" id="role" v-model="role">
    ...
    getData : function(){
      ...
      .then(response => {
        if(response.data.status == 1){
          ...
          this.$router.push({nama_siswa: "login"})
        }
